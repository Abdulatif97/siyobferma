@extends('layouts.app')
@php
    $title  = $diseaseCategory->name ?? 'Show Disease Category'
@endphp
@section('breadcrumb')
    {{ Breadcrumbs::render('diseaseCategory.show', $diseaseCategory) }}
@stop
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <div class="float-right">
                <a class="btn btn-primary" href="{{ route('diseaseCategory.index') }}"> Back</a>
            </div>
        </div>
